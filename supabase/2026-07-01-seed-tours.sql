...
select * from (values
  ...
  ('SYD-MW-WIN', 'Sydney Milky Way Hunt', 'ทริปถ่ายภาพตามล่าทางช้างเผือกใกล้ซิดนีย์', 'Sydney', 'Evening', 'oneday', 120::numeric, null, 4, 4, 0, 100::numeric, null, 'CONFIRMED', array['winter'], false),
