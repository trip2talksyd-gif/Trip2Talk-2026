...
export type TranslationKey =
  ...
  | 'about.awards.stat'
  | 'about.awards.cat.seascape'
  | 'about.awards.cat.bw'
  | 'about.awards.cat.creative'
  | 'about.awards.gallery'
  | 'about.awards.press.heading'
  | 'about.awards.press.1.name'
  | 'about.awards.press.1.context'
  | 'about.awards.press.2.name'
  | 'about.awards.press.2.context'
  | 'about.awards.press.3.name'
...
const en: Map = {
  ...
  'home.hero.badge': 'Photography trip with a pro photographer',
  ...
  'home.positioning.pillar1.desc':
    "Just 4–5 people a trip, so nobody's waiting around for their turn with the camera.",
  'home.positioning.pillar2.title': 'We Chase the Real Light',
  'home.positioning.pillar2.desc':
    "We plan around golden hour and blue hour because that's when places actually look their best.",
  ...
  'calendar.photo.sub':
    'One professional photographer with 10+ years of experience guides and drives every trip — just show up and shoot.',
  ...
  'calendar.photo.feature.2.title': 'Guides and drives',
  'calendar.photo.feature.2.desc': 'Your Trip Leader shoots and drives — 10+ years behind the lens',
  ...
  'about.hero.story':
    "We're not a tour company. Every Trip2Talk trip is a photography package first, a trip second — nature as your studio at golden hour, blue hour, and aurora windows, with one professional photographer who guides and drives you the whole way. Small groups (max 6), and we teach you how to get the shot yourself so you leave with stunning photos and new skills.",
  ...
  'about.awards.heading': 'Awards & Press',
  'about.awards.stat': '5× Bronze Award — Focus Awards 2016',
  'about.awards.cat.seascape': 'Seascape (×2)',
  'about.awards.cat.bw': 'Black & White (×1)',
  'about.awards.cat.creative': 'Creative (×2)',
  'about.awards.gallery': 'Award-winning photos',
  'about.awards.press.heading': 'Press',
  'about.awards.press.1.name': 'FOTOINFO Magazine',
  'about.awards.press.1.context': 'October 2014',
  'about.awards.press.2.name': 'Photo News (China)',
  'about.awards.press.2.context': 'Night-sky and star-trail photography feature',
  'about.awards.press.3.name': 'Thai Sawasdee',
  'about.awards.press.3.context': 'Sydney Opera House Vivid Festival feature, January 2023',
  'about.ploy.bio':
...
const th: Map = {
  ...
  'home.positioning.pillar1.desc':
    'ทริปละ 4-5 คน ไม่ต้องรอคิวถ่ายรูปนาน ทุกคนได้เวลากับกล้องเต็มที่',
  'home.positioning.pillar2.title': 'ตามล่าแสงจริง',
  'home.positioning.pillar2.desc':
    'เราวางแผนตามโกลเด้นอาวร์และบลูอาวร์ เพราะเป็นช่วงที่ทุกที่สวยที่สุดจริงๆ',
  ...
  'calendar.photo.eyebrow': 'ทุกทริปมีช่างภาพมืออาชีพ',
  'calendar.photo.heading.line1': 'ไปตัวเปล่า',
  'calendar.photo.heading.line2': 'กลับมาพร้อมรูปสวยเป็นร้อย',
  'calendar.photo.sub':
    'ช่างภาพมืออาชีพประสบการณ์กว่า 10 ปี เป็นทั้ง Trip Leader และคนขับทุกทริป — แค่มาแล้วถ่าย',
  'calendar.photo.feature.1.title': 'ช่างภาพมืออาชีพ',
  'calendar.photo.feature.1.desc': 'ไปด้วยทุกทริป ทุกกลุ่ม ไม่มีค่าใช้จ่ายเพิ่ม',
  'calendar.photo.feature.2.title': 'Trip Leader + คนขับ',
  'calendar.photo.feature.2.desc': 'ช่างภาพคนเดียวเป็นทั้งผู้นำทริปและคนขับ — ประสบการณ์กว่า 10 ปี',
  ...
  'calendar.banner.title': 'ทุกทริปมีช่างภาพมืออาชีพ',
  ...
  'about.hero.story':
    'เราไม่ใช่บริษัททัวร์ ทุกทริปของ Trip2Talk คือแพ็กเกจถ่ายภาพเป็นหลัก การท่องเที่ยวเป็นเรื่องรอง — ธรรมชาติคือสตูดิโอในช่วงโกลเด้นอาวร์ บลูอาวร์ และช่วงออโรร่า พร้อมช่างภาพมืออาชีพหนึ่งคนที่เป็นทั้ง Trip Leader และคนขับตลอดทริป กลุ่มเล็ก (สูงสุด 6 คน) และเราจะสอนให้คุณถ่ายเองได้ด้วย กลับบ้านไปพร้อมภาพสวยและสกิลใหม่',
  ...
  'about.awards.heading': 'รางวัลและสื่อ',
  'about.awards.stat': 'รางวัลบรอนซ์ 5 รางวัล — Focus Awards 2016',
  'about.awards.cat.seascape': 'ทิวทัศน์ทะเล (×2)',
  'about.awards.cat.bw': 'ขาวดำ (×1)',
  'about.awards.cat.creative': 'Creative (×2)',
  'about.awards.gallery': 'ภาพที่ได้รับรางวัล',
  'about.awards.press.heading': 'สื่อ',
  'about.awards.press.1.name': 'นิตยสาร FOTOINFO',
  'about.awards.press.1.context': 'ตุลาคม 2014',
  'about.awards.press.2.name': 'Photo News (จีน)',
  'about.awards.press.2.context': 'ฟีเจอร์ภาพท้องฟ้ายามค่ำคืนและ star trail',
  'about.awards.press.3.name': 'ไทยสวัสดี',
  'about.awards.press.3.context': 'ฟีเจอร์ซิดนีย์โอเปร่าเฮาส์ เทศกาล Vivid มกราคม 2023',
  'about.ploy.bio':
